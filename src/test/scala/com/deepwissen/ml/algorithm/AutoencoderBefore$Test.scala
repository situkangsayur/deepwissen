...
import com.deepwissen.ml.algorithm.test.AutoencoderBefore
 ...
 */
class AutoencoderBefore$Test extends FunSuite{
  ...
  test("traininig and classification and save model") {
    // training
    val network = AutoencoderBefore.train(finalDataSet, parameter)
